...
def run_basic_metrics_controller_get_recent_metrics_by_sensor_id_and_timestamp_for_all_metric_types():
    ...
    fullness_metrics=get_fullness_by_sensor_id_and_timestamp(f"{fullness_sensor.sensor_id}",current_time,datetime.now())
    ...
    usage_metrics=get_usage_by_sensor_id_and_timestamp(f"{usage_sensor.sensor_id}",current_time,datetime.now())
    ...
    weight_metrics=get_weight_by_sensor_id_and_timestamp(f"{weight_sensor.sensor_id}",current_time,datetime.now())
